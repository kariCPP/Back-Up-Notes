...
// Add Event Listeners to Canvas (Updated for touch support)
function addCanvasEventListeners() {
    ...
    canvas.ontouchend = function (e) {
        if (isPanning) {
            ...
            stopDrawing(e.changedTouches[0]); // Use the last touch point
        }
    };
...
function draw(e) {
    ...
    let pressure = e.force || 1; // Use force for Apple Pencil, or default to 1 for touch

    ctx.lineWidth = brushSize * pressure; // Adjust brush size based on pressure
    ctx.lineCap = 'round';
